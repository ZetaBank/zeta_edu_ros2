...
* Python으로 액션 서버 및 클라이언트를 작성하는 방법은 다양합니다. `ros2/examples <https://github.com/ros2/examples/tree/{REPOS_FILE_BRANCH}/rclpy/actions>`_ 저장소의 ``minimal_action_server`` 및 ``minimal_action_client`` 패키지를 확인하십시오.

* ROS 액션에 대한 자세한 정보는 `디자인 문서 <http://design.ros2.org/articles/actions.html>`__를 참조하십시오.
