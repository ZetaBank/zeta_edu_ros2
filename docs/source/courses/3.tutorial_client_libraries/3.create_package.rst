...
간단한 publisher/subscriber 시스템을 시작하며 이를 :doc:`C++ <./Writing-A-Simple-Cpp-Publisher-And-Subscriber>` 또는 :doc:`Python <./Writing-A-Simple-Py-Publisher-And-Subscriber>` 중 하나로 작성할 수 있습니다.
