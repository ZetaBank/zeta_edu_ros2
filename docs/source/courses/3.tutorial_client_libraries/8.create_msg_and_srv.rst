...
그런 다음 두 개의 새로운 터미널을 열고 각각에서 ``ros2_ws``를 소스로 만들고 다음을 실행하십시오:
...
자세한 내용은 :doc:`ROS 2 인터페이스에 관한 정보 <https://docs.ros.org/en/humble/Concepts/Basic/About-Interfaces.html>__` 에서 확인할 수 있습니다.
