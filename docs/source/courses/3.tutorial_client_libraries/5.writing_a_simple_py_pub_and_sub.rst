...
다시 한 번, :doc:`C++ <./Writing-A-Simple-Cpp-Service-And-Client>` 또는 :doc:`Python <./Writing-A-Simple-Py-Service-And-Client>` 중 어느 언어로 작성할지 선택할 수 있습니다.

관련 콘텐츠
~~~~~~~~~~~~~~

Python으로 퍼블리셔와 서브스크라이버를 작성하는 다양한 방법이 있습니다. `ros2/examples <https://github.com/ros2/examples/tree/{REPOS_FILE_BRANCH}/rclpy/topics>`_ 리포지토리의 ``minimal_publisher`` 와 ``minimal_subscriber`` 패키지를 확인해보세요.
